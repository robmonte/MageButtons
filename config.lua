	...
	if(event == "ADDON_LOADED" and arg1 == "MageButtons") then
		...
		for i = 1, 6, 1 do
			...
			elseif i == 2 then
				...
				buttonTypeTable2 = { btype2, "Water", "Food", "Teleports", "Portals", "Gems", "Polymorph", "none"}
			elseif i == 3 then
				btype3 = MageButtons:getSV("buttons", "c") or defaultValue
				buttonTypeTable3 = { btype3, "Water", "Food", "Teleports", "Portals", "Gems", "Polymorph", "none"}
			elseif i == 4 then
				btype4 = MageButtons:getSV("buttons", "d") or defaultValue
				buttonTypeTable4 = { btype4, "Water", "Food", "Teleports", "Portals", "Gems", "Polymorph", "none"}
			elseif i == 5 then
				btype5 = MageButtons:getSV("buttons", "e") or defaultValue
				buttonTypeTable5 = { btype5, "Water", "Food", "Teleports", "Portals", "Gems", "Polymorph", "none"}
			elseif i == 6 then
				btype6 = MageButtons:getSV("buttons", "f") or defaultValue
				buttonTypeTable6 = { btype6, "Water", "Food", "Teleports", "Portals", "Gems", "Polymorph", "none"}
			end
